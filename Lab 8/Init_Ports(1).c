...
void Port4_Init(void){
  ...
  P4REN |= (BIT0 | BIT1 | BIT2 | BIT3 | BIT4 | BIT5);

  // Configure pull-up resistors
  P4OUT |= (BIT0 | BIT1 | BIT2 | BIT3 | BIT4 | BIT5);

  // Enable interrupts on P4.0 - P4.5
  P4IE |= (BIT0 | BIT1 | BIT2 | BIT3 | BIT4 | BIT5);  // Enable interrupt
  P4IES |= (BIT0 | BIT1 | BIT2 | BIT3 | BIT4 | BIT5); // Interrupt on high-to-low transition
  P4IFG &= ~(BIT0 | BIT1 | BIT2 | BIT3 | BIT4 | BIT5); // Clear any pending interrupts
}
...
void Port5_Init(void){
  ...
  // Disable pull resistors since external circuit handles this
  P5REN &= ~(BIT0 | BIT1 | BIT2 | BIT3);
  
  // Ensure alternate functions are disabled
...
void Port7_Init(void){
  P7DIR &= ~(BIT0 | BIT1 | BIT2 | BIT3 | BIT4 | BIT5 | BIT6 | BIT7);
    ...
    // Ensure alternate functions are disabled
    P7SEL0 &= ~(BIT0 | BIT1 | BIT2 | BIT3 | BIT4 | BIT5 | BIT6 | BIT7);
    P7SEL1 &= ~(BIT0 | BIT1 | BIT2 | BIT3 | BIT4 | BIT5 | BIT6 | BIT7);
    
    // Initialize outputs low (for charge/discharge cycle)
...
void Port9_Init(void){
    // Configure P9.2 as output (sensor control)
    P9DIR |= BIT2;
